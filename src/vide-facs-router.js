  ...
  renderViewer(pages) {
    this.contentEl.setContent(`
      <div class="spa-view facsimile-view">
        ...
        <!-- Modal -->
        <div id="notebook-modal" style="display: none; position: fixed; top: 15%; left: 15%; right: 15%; bottom: 15%; background-color: white; border: 2px solid #333; border-radius: 8px; z-index: 9999; box-shadow: 0 4px 20px rgba(0,0,0,0.5); flex-direction: column;">
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1.5rem; border-bottom: 1px solid #ccc; background-color: #f9f9f9;">
            <h2 style="margin: 0; font-size: 1.1rem; color: #333; font-weight: normal;">Ludwig van Beethoven: Notirungsbuch K</h2>
            <button id="close-modal" style="padding: 0.25rem 0.75rem; background-color: #e8e8e8; color: #666; border: 1px solid #ccc; border-radius: 3px; cursor: pointer; font-size: 0.9rem;">✕ Schließen</button>
          </div>
          <div style="flex: 1; overflow-y: auto;">
            <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
              <thead>
                <tr style="background-color: #f0f0f0; border-bottom: 2px solid #ccc;">
                  <th colspan="2" style="padding: 0.75rem; text-align: center; font-weight: bold; border-right: 1px solid #ccc;">Verso</th>
                  <th colspan="2" style="padding: 0.75rem; text-align: center; font-weight: bold;">Recto</th>
                </tr>
                <tr style="background-color: #f0f0f0; border-bottom: 1px solid #ccc;">
                  <th style="padding: 0.5rem; text-align: left; font-weight: normal; width: 10%; border-right: 1px solid #e0e0e0;">Seite</th>
                  <th style="padding: 0.5rem; text-align: left; font-weight: normal; width: 40%; border-right: 1px solid #ccc;">Quelle mit Seitenzählung</th>
                  <th style="padding: 0.5rem; text-align: left; font-weight: normal; width: 40%; border-right: 1px solid #e0e0e0;">Quelle mit Seitenzählung</th>
                  <th style="padding: 0.5rem; text-align: left; font-weight: normal; width: 10%;">Seite</th>
                </tr>
              </thead>
              <tbody>
                <tr style="background-color: #fffef0;">
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 1</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">1</a></td>
                </tr>
                <tr>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">2</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 2</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 3</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">3</a></td>
                </tr>
                <tr>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">4</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 4</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 5</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">5</a></td>
                </tr>
                <tr>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">6</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 6</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 7</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">7</a></td>
                </tr>
                <tr>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">8</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 8</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB BSk 21/69: 1r</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">9</a></td>
                </tr>
                <tr>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">10</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #ccc; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB BSk 21/69: 1v</a></td>
                  <td style="padding: 0.5rem; border-right: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;"><a href="#" style="color: #0066cc;">D-BNba, HCB MH 60 ("Engelmann"): 9</a></td>
                  <td style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; text-align: right;"><a href="#" style="color: #0066cc; font-weight: bold;">11</a></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="side-panel" id="side-panel">
          ...
          <div class="side-panel-content" id="side-panel-content">
            ...
            <div class="panel-section active" data-panel="zones">
              <button id="show-filter-btn" style="width: 100%; padding: 0.75rem; margin-bottom: 1rem; background-color: #c62828; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 1rem; font-weight: 500;">Filter</button>
              <ul style="list-style: none; padding-left: 0; margin: 0;">
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/1">NK 1/1</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/2">NK 1/2</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/3">NK 1/3</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/4">NK 1/4</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/5">NK 1/5</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/6">NK 1/6</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/7">NK 1/7</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/8">NK 1/8</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/9">NK 1/9</li>
                <li style="padding: 0.5rem; border-bottom: 1px solid #e0e0e0; cursor: pointer;" data-zone="NK 1/10">NK 1/10</li>
                <li style="padding: 0.5rem; cursor: pointer;" data-zone="NK 1/11">NK 1/11</li>
              </ul>
            </div>
            <!-- Panel 2: Filter Panel -->
            <div class="panel-section" data-panel="filter">
              <div style="position: relative; padding-bottom: 1rem; border-bottom: 1px solid #e0e0e0; margin-bottom: 1rem;">
                <button id="cancel-filter-btn" title="Abbrechen" style="position: absolute; top: 0; right: 0; width: 2.5rem; height: 2.5rem; background-color: transparent; color: #666; border: 1px solid #ccc; border-radius: 4px; cursor: pointer; font-size: 1.2rem; font-weight: bold; line-height: 1; z-index: 10;">×</button>
              </div>
              <h4>Suchraum</h4>
              <div class="filterbox" style="margin-bottom: 1.5rem;">
                <label><input type="checkbox" name="suchraum" value="current-page"> Auf aktuelle Doppelseite beschränken</label>
              </div>
              <h4>Vorzeichnung</h4>
              <div class="filterbox" style="display: flex; flex-direction: column; gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 1rem;">
                  <div id="vorzeichnung-current" style="min-width: 2.5em; text-align: right; font-family: 'Bravura', 'MusGlyphs', 'Arial', sans-serif; font-size: 1.2rem; font-weight: 600;">0</div>
                  <input type="range" id="vorzeichnung-slider" name="vorzeichnung" min="0" max="14" value="7" step="1" style="flex: 1;">
                </div>
              ...
              <div class="filterbox" style="display: flex; gap: 2rem;">
              ...
              <div class="filterbox">
                <ul style="list-style: none; padding-left: 0; margin: 0;">
                  ...
                  <li style="padding-left: 1.5rem;"><label><input type="checkbox" name="werkbezug" value="Op.125-1"> 1. Satz</label></li>
                  <li style="padding-left: 1.5rem;"><label><input type="checkbox" name="werkbezug" value="Op.125-2"> 2. Satz</label></li>
                  <li style="padding-left: 1.5rem;"><label><input type="checkbox" name="werkbezug" value="Op.125-3"> 3. Satz</label></li>
                  <li style="padding-left: 1.5rem;"><label><input type="checkbox" name="werkbezug" value="Op.125-4"> 4. Satz</label></li>
              ...
              <!-- Apply Filter Button -->
              <button id="apply-filter-btn" style="width: 100%; padding: 0.75rem; margin-top: 1rem; background-color: #c62828; color: white; border: none; cursor: pointer; font-size: 1rem; font-weight: 500;">Filter anwenden</button>
            </div>
          </div>
        </div>
      </div>
