...
To point the component at a different API root, pass `api-base` on the root element:

```html
<vide-facs api-base="https://example.org/exist/apps/api/document"></vide-facs>
```

To override the manifest-to-URL mapping, pass `documents` as JSON:

```html
<vide-facs
    api-base="https://example.org/exist/apps/api/document"
    documents='{"NK":"m57bab171-9222-451d-8f7d-7fe7db6064bb/overview.json"}'
></vide-facs>
```
